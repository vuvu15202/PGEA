...
module.exports = {
  ...
  session: {
    ...
    db: ((+process.env.REDIS_DB) || 0) + 1,
    host: process.env.REDIS_HOST || '13.250.57.155',
    pass: process.env.REDIS_PASS || (process.env.REDIS_PASS === undefined ? 'FUFLfr/T72ueufr7YpkOooOSXDTWMgvjc0DWHXy1x372YrJwH6gFjSNHH3X+03L1j3O1fcZGqDjRilZj' : ""),
